...
echo.
echo ============================================================
echo  FH6 Radio Tool v2.7.13 - Environment Setup
echo ============================================================
echo.
...
echo Audio conversion uses FFmpeg. imageio-ffmpeg will be installed automatically.
echo Normally you do NOT need to manually add ffmpeg.exe to PATH.
echo.
...
echo.
echo [3/3] Quick import and FFmpeg check...
...
%PY_EXE% -c "import imageio_ffmpeg; print('Bundled FFmpeg OK:', imageio_ffmpeg.get_ffmpeg_exe())"
if errorlevel 1 (
  echo.
  echo [ERROR] imageio-ffmpeg / bundled FFmpeg check failed.
  echo Please run this setup script again.
  echo.
  pause
  exit /b 1
)
